...
//.75
    ...
    private final SwerveRequest.RobotCentric drive = new SwerveRequest.RobotCentric()
            .withDeadband(MaxSpeed * 0.4).withRotationalDeadband(MaxAngularRate * 0.2) // Add a 10% deadband //0.3
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("align to left side", new Shift(drivetrain, m_vision, MaxSpeed, Vision.shiftDirection.LEFT));
        NamedCommands.registerCommand("align to right side", new Shift(drivetrain, m_vision, MaxSpeed, Vision.shiftDirection.RIGHT));
    ...
    private void configureBindings() {
        ...
        ControllerConstants.driverController.povLeft().whileTrue(new Shift(drivetrain, m_vision, MaxSpeed, Vision.shiftDirection.LEFT));
        ControllerConstants.driverController.povRight().whileTrue(new Shift(drivetrain, m_vision, MaxSpeed, Vision.shiftDirection.RIGHT));
