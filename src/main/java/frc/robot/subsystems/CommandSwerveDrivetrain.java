...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
   ...
   public static SwerveRequest.ApplyRobotSpeeds m_request = new SwerveRequest.ApplyRobotSpeeds();
    ...
    public void periodic() {
        ...
        if (ControllerConstants.driverController.povRight().getAsBoolean()){

            SmartDashboard.putNumber("x drive",this.getState().Pose.getX());
            SmartDashboard.putNumber("y drive",this.getState().Pose.getY());
            SmartDashboard.getNumber("y drive",this.getState().Pose.getRotation().getDegrees());

            System.out.println("POSITION" + this.getState().Pose.getX() + this.getState().Pose.getY() + this.getState().Pose.getRotation());
        }
        /*
